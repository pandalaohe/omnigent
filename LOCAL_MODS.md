...
- [260913] **Seven post-merge repairs, and the gate that found them** (board OMN02 / task T260912-012, commits `a486bef5f` `9e5aa54eb` `38927089f`). The re-align entry above reported `tsc -b` and `oxlint` green. Both were green at every point in this sequence and **neither saw a single one of the seven defects**; the web suite found all of them. Two rounds.
