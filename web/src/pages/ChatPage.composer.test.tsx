...
describe("Composer shared visible controls", () => {
  ...
  it("mounts sub-agent work after the background indicator with navigation", () => {
    useChatStore.setState({
...
describe("Composer paste", () => {
  ...
  it("attaches files pasted while the slash menu is open, closing the menu", () => {
    ...
    // closes its menu the same way once the attach token lands. The parity
    // suite in NewChatDialog.test.tsx asserts this exact contract.
    setComposerState({
      conversationId: "conv_test",
      skills: [{ name: "deslop", description: "Remove AI slop" }],
    });
    ...
    expect(screen.getByAltText("shot.png")).toBeTruthy();
    expect(textarea().value).toBe("/de [image 1] ");
