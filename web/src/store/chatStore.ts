...
export function beginLocalConversation(
  ...
  // Fork mod: visual order of an inline-attachment draft (MOD-s10). Last, so
  // the leading five keep their upstream positions.
  composerParts?: readonly ComposerDraftPart[],
