...
@pytest.mark.parametrize("target_name", ["outside", "cache-sibling", "cache/other-agent"])
def test_replace_does_not_follow_obsolete_staging_symlink(
    agent_cache: AgentCache,
    artifact_store: LocalArtifactStore,
    cache_dir: Path,
    tmp_path: Path,
    ...
    """Unique staging leaves an attacker-controlled old staging path untouched."""
    bundle_location = "agent-1/abc123"
