...
def _build_host_daemon_env(
    *,
    ...
    # Windows' legacy console encoding can reject status glyphs before the
    # daemon has a chance to report that it is ready. Keep an explicit user
    # choice authoritative while making UTF-8 the safe daemon default.
