            ...
            if listed and not flagged and permission_store is not None:
                ...
                try:
                    ...
                    await asyncio.to_thread(
                        promote_if_listed, admin_list, permission_store, user_id
                    )
            ...
            for host_id in {conv.host_id for conv in convs if conv.host_id is not None}:
                ...
                if host is None:
                    ...
                    try:
                        ...
                        _logger.warning(
                            "CLI retention release failed for deleted Host %s",
                            host_id,
                            exc_info=True,
                        )
                elif host is not None and host.cli_retention_policy is None:
